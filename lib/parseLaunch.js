...
var parseLaunch = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var launchBody, wasAssignmentLaunch, launchType, assignment, outcome, acceptedDataValues, launchAppTitle, isAdmin, isDesigner, isInstructor, isLearner, isNonCreditLearner, isCreditLearner, isTA, isTTM, notInCourse, extRoles, roles, customParams, selfLaunchState, launchInfo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!req.session.cacclLTISelfLaunchState) return [3 /*break*/, 2];
            ...
            case 2:
                launchInfo = {
                    ...
                    selfLaunchState: selfLaunchState,
                };
                /*----------------------------------------*/
                /*              Update State              */
                /*----------------------------------------*/
