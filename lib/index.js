...
var initLTI = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var app, installationCredentials, authorizeAfterLaunch, selfLaunch, initNonceStore, appIdStore_1, api_1, store, startTimestamp;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                app = opts.app, installationCredentials = opts.installationCredentials, authorizeAfterLaunch = opts.authorizeAfterLaunch, selfLaunch = opts.selfLaunch;
                initNonceStore = ((_a = opts.initNonceStore) !== null && _a !== void 0 ? _a : caccl_memory_store_1.default);
                if (!selfLaunch) return [3 /*break*/, 2];
                return [4 /*yield*/, selfLaunch.initAppIdStore(APP_ID_LIFESPAN_SEC_1.default)];
            case 1:
                appIdStore_1 = _b.sent();
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                if (!selfLaunch) {
                                    return [2 /*return*/, res.status(404).send('This app is not prepared to be launched from outside of Canvas. Please contact support.')];
                                }
                                ...
                                canvasHost = decodeURIComponent(String(req.query.canvasHost));
                            ...
                            case 1:
                                ...
                                _a.label = 2;
                            case 2:
                                if (!(!appId && selfLaunch.adminAccessTokenMap)) return [3 /*break*/, 9];
                                accessTokens = (selfLaunch.adminAccessTokenMap[canvasHost]
                                    || []);
                                i = 0;
                                _a.label = 3;
                            case 3:
                            ...
                            case 9:
                                ...
                                if (req.query.selfLaunchState) {
                                    try {
                                        ...
                                        req.session.cacclLTISelfLaunchState = JSON.parse(decodeURIComponent(String(req.query.selfLaunchState)));
                                    }
                                    catch (err) {
                                        return [2 /*return*/, res.status(500).send('This app cannot be launched this way because we could not store state before continuing. Please contact support.')];
                                    }
                                }
...
var getSelfLaunchURL = function (opts) {
    var courseId = opts.courseId, canvasHost = opts.canvasHost, appId = opts.appId, selfLaunchState = opts.selfLaunchState;
    // Build the URL
    ...
    if (selfLaunchState) {
        url += "&selfLaunchState=".concat(encodeURIComponent(selfLaunchState));
    }
    return url;
};
