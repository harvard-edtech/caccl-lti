...
var initLTI = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var app, installationCredentials, dontAuthorizeAfterLaunch, selfLaunch, initNonceStore, appIdStore_1, api_1, store, startTimestamp;
    var _a;
                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                if (!appId
                                    ...
                                    appId = CACCL_SIM_TOOL_ID_1.default;
                                }
                                // > Get from query
                                if (!appId
                                    && req.query.appId
