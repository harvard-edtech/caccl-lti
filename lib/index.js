                        ...
                        switch (_b.label) {
                            ...
                            case 7:
                                app_1 = apps.find(function (candidateApp) {
                                    ...
                                    return (candidateApp.url.startsWith("http://".concat(req.hostname).concat(CACCL_PATHS_1.default.LAUNCH))
                                        || candidateApp.url.startsWith("https://".concat(req.hostname).concat(CACCL_PATHS_1.default.LAUNCH)));
                                });
                                if (app_1) {
                                    appId = app_1.id;
                                    return [3 /*break*/, 9];
                            ...
                            case 9:
                                ...
                                if (req.query.selfLaunchState) {
                                    ...
                                    req.session.selfLaunchState = JSON.parse(decodeURIComponent(String(req.query.selfLaunchState)));
                                    // Store
                                    req.session.save();
                                }
...
var getSelfLaunchURL = function (opts) {
    ...
    if (selfLaunchState) {
        url += "&selfLaunchState=".concat(encodeURIComponent(JSON.stringify(selfLaunchState)));
    }
    return url;
};
