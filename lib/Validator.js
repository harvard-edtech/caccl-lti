...
var Validator = /** @class */ (function () {
    ...
    Validator.prototype.checkSignature = function (req) {
        ...
        var path = (0, url_parse_1.default)(originalUrl).pathname;
        ...
        // > Create signature
        var generatedSignature = decodeURIComponent(oauth_signature_1.default.generate(req.method, url, body, this.consumerSecret));
